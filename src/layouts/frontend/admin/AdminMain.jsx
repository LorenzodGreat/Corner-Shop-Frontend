...
const navigation = [
    ...
    { name: 'Payments', href: '/Admin/Payments', icon: CashIcon, current: false },
]
            ...
            <div>
                <Transition.Root show={sidebarOpen} as={Fragment}>
                    <Dialog as="div" className="fixed inset-0 flex z-40 md:hidden" onClose={setSidebarOpen}>
                        ...
                        >
                            <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-gradient-to-r from-sky-800 to-cyan-600 text-white">
                                <Transition.Child
                                    as={Fragment}
                                        ...
                                        {navigation.map((item) => (
                                            <a
                                                ...
                                                className={classNames(
                                                    item.current ? 'bg-gradient-to-r from-sky-800 to-cyan-600 text-white' : 'text-indigo-100 hover:bg-indigo-600',
